# tool-pi-game Constitution

この文書は、tool-pi-game の開発組織における最上位 contract です。
...
tool-pi-game の開発組織の目的は current procedure への服従ではありません。
...
This repository owns one my-web-2025 tool source package. The host application remains a separate authority.

## Upstream source

`rebuildup/project-init@release-0-3-0` is the governance reconciliation baseline. Agent Skills track current upstream.
